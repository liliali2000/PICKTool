...
class IngestionConfiguration(QWidget):
    def __init__(self, clientHandler):
        ...
        # instantiated deleteButton
        self.deleteButton = QtWidgets.QPushButton(self)
        self.deleteButton.clicked.connect(LogEntryManager.deleteLogEntriesDb)
        self.directoryConfigurationLayout.addWidget(self.deleteButton)
    ...
    def initializeText(self):
        ...
        #self.deleteButton.setText("Delete All Logs")
        #self.deleteButton.setFont(QtGui.QFont('SansSerif', 7))
    ...
    def ingestLogsClicked(self):
        # Uncomment out lines 143, 145, 146 after fixing bug

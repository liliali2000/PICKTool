...
class LogEntryManager:
    def __init__(self):
        ...
        self.client = pymongo.MongoClient('mongodb+srv://admin:Welcome@picktoolcluster.vllzs.mongodb.net/local?retryWrites=true&w=majority')
        self.db = self.client["database"]
        # Possibly adding data to collection named "entries" in MongoDB
